...
The cutest Discord client mod, this a fork of [Vencord]([https://github.com/synqat/vencord-theme](https://github.com/Vendicated/Vencord)), with the goal of bringing back deleted plugins, everything here is from the original repo.
