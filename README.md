# Vencord-Open, this a fork of [Vencord]([https://github.com/synqat/vencord-theme](https://github.com/Vendicated/Vencord)), with the goal of bringing back deleted plugins
